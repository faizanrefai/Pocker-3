...
- (IBAction)comprarPressed:(id)sender {
   ...
   // [[MKStoreManager sharedManager] buyFeature:@"com.hine30days.poker"];
   
    
   // [MKStoreManager sharedManager].productId = @"com.hine30days.poker";
    
    [[MKStoreManager sharedManager] buyFeature:kFeatureA1Id];

    
 //   [[MKStoreManager sharedManager] buyFeature:@"com.hint30DaysSub.poker"];
